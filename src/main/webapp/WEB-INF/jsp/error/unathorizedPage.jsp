...
<head>
  ...
  width: 130px;
  background-color: #8594A5;
  animation: fadeIn 1s forwards; /* Using fadeIn animation for opacity transition */
  opacity: 0; /* Start with the button invisible */
}

@keyframes fadeIn {
  0% {
    opacity: 0; /* Button is invisible at the beginning */
  }
  100% {
    opacity: 1; /* Button becomes fully visible at the end */
  }
}
