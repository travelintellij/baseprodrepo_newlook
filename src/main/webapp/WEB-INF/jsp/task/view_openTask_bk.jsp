...
<div class="sidenav">
  ...
  <a href="view_open_task_form_user" style="background-color: #2E3F50;">Open Tasks</a>
...
<div class="main">
  ...
  <form:form action="view_open_task_form_user" modelAttribute="TASK_FILTER_OBJ">
		...
		<tr>
			...
			<td><input style="width:150px;" class="form-control search-slt" type="number" name="taskId" id="taskId" step="0.0" placeholder="Task Id " /></td><td colspan="7">&nbsp;</td>
		</tr>
		<tr>
			<td>
						<div class="select">
				...
				<td style="height:30px"><a href="view_open_task_form_user"><input type="button" value="Clear Filter" /></a></td>
			</tr>
		</table>
		<hr>
			...
			<table>
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_task_form_user?sortBy=taskId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Task Id</a></th>
				<th style="width:20%;">Task Title</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_task_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_task_form_user?sortBy=taskOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_task_form_user?sortBy=taskPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_task_form_user?sortBy=taskDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Due Date</a></th>
			...
			<tr>
				...
				<td style="width:20%;">
					<a href="view_view_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_task_req?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;"value="Edit" /></a> | 
					<a href="view_form_delete_task?taskId=${openTaskList.taskId}"><input type="button" style="background-color: #786AAF;"value="Delete" /></a>
				</td>
			</tr>
