...
<div class="main">
  ...
  <br><br>
  <form:form action="view_open_my_assigned_task_form_user" modelAttribute="TASK_FILTER_OBJ">
		<table style="width: 100%;">
			<tr >
				...
				<td style="height:30px"><a href="view_open_my_assigned_task_form_user"><input type="button" value="Clear Filter" /></a></td>
			</tr>
		</table>
		<hr>
			...
			<table>
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_assigned_task_form_user?sortBy=taskId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Task Id</a></th>
				<th style="width:20%;">Task Title</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_assigned_task_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_my_assigned_task_form_user?sortBy=taskOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_assigned_task_form_user?sortBy=taskPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_my_assigned_task_form_user?sortBy=taskDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Due Date</a></th>
			...
			<tr>
				...
				<td style="width:20%;">
					<a href="view_view_my_assigned_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_my_assigned_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="Edit" /></a> | 
					<a href="view_form_delete_my_assigned_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="Delete" /></a>
				</td>
			</tr>
			    ...
			    <c:url value="view_open_my_assigned_task_form_user" var="next">
			        <c:param name="page" value="${page + 1}"/>
			    </c:url>
