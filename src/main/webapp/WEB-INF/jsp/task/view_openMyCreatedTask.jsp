    ...
    <div class="create_by_me_tasks container">
        ...
        <table class="due_date_task_tabel">
            <thead>
                <tr>
                    <th><a
                            href="view_open_my_created_task_form_user?sortBy=taskId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Task
                            Id</a></th>
                    <th>Task Title</th>
                    <th><a
                            href="view_open_my_created_task_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Deal
                            Associated</a></th>
                    <th><a
                            href="view_open_my_created_task_form_user?sortBy=taskOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Assigned
                            To</a></th>
                    <th><a
                            href="view_open_my_created_task_form_user?sortBy=taskPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Priority</a>
                    </th>
                    <th><a
                            href="view_open_my_created_task_form_user?sortBy=taskDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Due
                            Date</a></th>
                    <th>Action</th>
                </tr>
            </thead>
                ...
                <tr>
                    ...
                    <td style="width:20%;">
                        ...
                        <a href="view_form_delete_my_created_task?taskId=${openTaskList.taskId }"><input type="button"
                                style="background-color: #786AAF;" value="Delete" /></a></th>
                    </td>
                </tr>
                </c:forEach>
                </tr>
