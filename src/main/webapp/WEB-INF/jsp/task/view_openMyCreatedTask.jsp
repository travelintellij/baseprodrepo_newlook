...
<head>
    ...
    <title>created by me (tasks)</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/revamped/style.css">
</head>

<body
    style="background: url(${pageContext.request.contextPath}/resources/images/revamped/created_by_me_tasks_bg.jpg);background-size: cover; background-repeat: no-repeat; background-position: center center;background-attachment: fixed;">
    ...
    <div class="cnt_options">
         <a href="view_create_ticket_form_user">Create Task</a>
            ...
            <a href="view_open_my_created_task_form_user" style="color:white;background:black">Created By Me</a>
    ...
    <div class="create_by_me_tasks container">
        <div class="created_by_me_wrapper">
            ...
            <form:form action="view_open_my_created_task_form_user" modelAttribute="TASK_FILTER_OBJ">
                <div class="created_by_me_data">
                    <div class="created_by_me_data_li" class="my_created_task_sel">
                    ...
                    <div class="created_by_me_data_li">
                ...
                <div class="due_today_task_data_btns">
                    ...
                    <a href="view_open_my_created_task_form_user">Clear Filter</a>
                </div>
        </div>
        ...
        <table class="due_date_task_tabel">
            <thead>
                <tr>
                    <th><a
                         style="color:#FFBA08"   href="view_open_my_created_task_form_user?sortBy=taskId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Task
                            Id</a></th>
                    <th>Task Title</th>
                    <th><a
                         style="color:#FFBA08"    href="view_open_my_created_task_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Deal
                            Associated</a></th>
                    <th><a
                         style="color:#FFBA08"    href="view_open_my_created_task_form_user?sortBy=taskOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Assigned
                            To</a></th>
                    <th><a
                         style="color:#FFBA08"    href="view_open_my_created_task_form_user?sortBy=taskPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Priority</a>
                    </th>
                    <th><a
                        style="color:#FFBA08"     href="view_open_my_created_task_form_user?sortBy=taskDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Due
                            Date</a></th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:20%;">
                        ...
                        <a href="view_form_delete_my_created_task?taskId=${openTaskList.taskId }"><input type="button"
                             style="color:red;background:transparent;border:none;outline:none"     value="Delete" /></a></th>
                    </td>
                </tr>
                </c:forEach>
                </tr>
