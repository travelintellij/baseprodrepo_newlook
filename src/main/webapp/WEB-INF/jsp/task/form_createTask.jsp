...
<div class="sidenav">
  <a href="#" style="background-color: #2E3F50;">Create Task</a>
...
<div class="main">
  ...
  <table>
	...
	<tr>
  		<td colspan="2">
			<input style="width:450px;" class="form-control search-slt" type="text" name="taskTitle" id="taskTitle" placeholder="Title" required /> 
  		</td>
	</tr>
	<tr>
	...
	<td>
		<div class="select">
			<select id = "taskPriority" name="taskPriority" style="width: 180px;" required>
	...
	<td>
		 <!-- <input style="height: 30px; width: 180px;" type="datetime-local" name="taskDueDate" required />  -->  
		<input style="height: 30px; width: 180px;" id="taskDueDate" name="taskDueDate" required />
		<!--
		 
		<input type="hidden" name="taskDueDate" id="taskDueDate" />
		<input style="height: 30px; width: 180px;" type="date" name="dueDate" required />
		<input style="height: 30px; width: 180px;" type="time" name="duetime" value="04:29 AM" required />
		 -->
	...
	<tr>
		<td colspan="2">
			<input style="width:450px;" class="form-control search-slt" type="text" name="dealName" id="dealName" placeholder="Deal Search - Enter Only numeric Deal # or Client Name " />
	...
	<tr>
	<td colspan="2"><textarea style="width: 450px;" rows="6" cols="250" name="taskDescription"></textarea></td>
	</tr>
	<tr>
		<td style="text-align:right;">
				<input style="width: 80px; background-color: green" type="submit" id="create" value="Create" />
		</td>
