...
<div class="main">
  ...
  <br><br>
  <form:form action="view_open_my_created_task_form_user" modelAttribute="TASK_FILTER_OBJ">
		<table style="width: 100%;">
			<tr >
		        ...
		        <td><input type="date" name="DateFrom" style="height:30px;"/></td>
		        <td><input type="date" name="DateTo" style="height:30px;"/></td>
	 			<td style="height:30px"><input style="background-color:red;" type="submit" value="Apply Filter" /> </td>
				<td style="height:30px"><a href="view_open_my_created_task_form_user"><input type="button" value="Clear Filter" /></a></td>
			</tr>
		</table>
		<hr>
			...
			<table>
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_created_task_form_user?sortBy=taskId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Task Id</a></th>
				<th style="width:20%;">Task Title</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_created_task_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_my_created_task_form_user?sortBy=taskOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_my_created_task_form_user?sortBy=taskPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_my_created_task_form_user?sortBy=taskDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&taskOwner=${taskOwner}&dealConfirmationId=${dealConfirmationId}&taskPriority=${taskPriority}">Due Date</a></th>
			...
			<tr>
				...
				<td style="width:20%;">
					<a href="view_view_my_created_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_my_created_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="Edit" /></a> | 
					<a href="view_form_delete_my_created_task?taskId=${openTaskList.taskId }"><input type="button" style="background-color: #786AAF;" value="Delete" /></a></th>
				</td>
			</tr>
				...
				Page: 
			    <c:url value="view_open_my_created_task_form_user" var="prev">
			    ...
			    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
			        <c:choose>
			            ...
			            <c:otherwise>
			                <c:url value="view_open_my_created_task_form_user" var="url">
			    ...
			    <c:url value="view_open_my_created_task_form_user" var="next">
			        <c:param name="page" value="${page + 1}"/>
			    </c:url>
