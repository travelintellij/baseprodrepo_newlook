...
<body>
 ...
 <div class="cnt_options ">
            ...
            <a href="get_visa_service_line_queue_user" style="color:white;background:black">Visa</a>
...
<form:form action="get_visa_service_line_queue_user" modelAttribute="FILTER_SL">
        <div class="view_task_wrapper bs">
            ...
            <div class="due_today_task_data_btnss" style="display:flex;justify-content:center;margin-top:10px">
              ...
              <a href="get_visa_service_line_queue_user"><input type="button" value="Clear Filter" /></a>
            </div>
        </div>
	
	</div>
		<c:set value="${VSA_PAGE_LIST}" var="fltPageList" />
	<table class="view_task_table" style="width:80%; margin-left: auto;margin-right: auto;">
        <thead style="background:#6082B6;height:50px;">
            <tr>
                ...
                <th style="width:10%;"><a style="color:black;" href="#">Visa Country</a></th>
                <th style="width:10%;"><a style="color:black;" href="#">Travel Start Date</a></th>
                <th style="width:10%;"><a style="color:black" href="#">Travel End Date</a></th>
		...
		<c:forEach items="${fltPageList}" var="flt">
				<tr>
					...
					<td style="width:10%;">${flt.countryName}</td>
					<td style="width:10%;"><fmt:formatDate value="${flt.travelStartDate}" pattern="dd-MM-yyyy" /></td>
					<td style="width:10%;"><fmt:formatDate value="${flt.travelReturnDate}" pattern="dd-MM-yyyy" /></td>
