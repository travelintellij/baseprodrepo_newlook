...
<form:form action="get_hotel_service_line_queue_user" modelAttribute="FILTER_SL">
        <div class="view_task_wrapper bs">
            ...
            <div class="due_today_task_data_btnss" style="display:flex;justify-content:center;margin-top:10px">
              ...
              <a href="get_hotel_service_line_queue_user"><input type="button" value="Clear Filter" /></a>
            </div>
        </div>
	
	</div>
		<c:set value="${HTL_PAGE_LIST}" var="fltPageList" />
	<table class="view_task_table" style="width:80%; margin-left: auto;margin-right: auto;">
        <thead style="background:#6082B6;height:50px;">
            <tr>
                ...
                <th style="width:15%;"><a style="color:black;" href="#">Hotel Name</th>
                <th style="width:10%;"><a style="color:black;" href="#">City</a></th>
                <th style="width:10%;"><a style="color:black;" href="#">Check In</a></th>
                <th style="width:10%;"><a style="color:black" href="#">Check Out</a></th>
		...
		<c:forEach items="${fltPageList}" var="flt">
				<tr>
					...
					<td style="width:15%;">${flt.hotelName}</td>
					<td style="width:10%;">${flt.cityName}</td>
					<td style="width:10%;">${flt.checkInDate}</td>
					<td style="width:10%;">${flt.checkOutDate}</td>
