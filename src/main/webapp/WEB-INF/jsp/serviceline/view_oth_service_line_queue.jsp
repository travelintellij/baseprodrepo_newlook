...
<body>
 ...
 <div class="cnt_options ">
            ...
            <a href="get_other_service_line_queue_user"  style="color:white;background:black">Other</a>
...
<form:form action="get_other_service_line_queue_user" modelAttribute="FILTER_SL">
        <div class="view_task_wrapper bs">
            ...
            <div class="due_today_task_data_btnss" style="display:flex;justify-content:center;margin-top:10px">
              ...
              <a href="get_other_service_line_queue_user"><input type="button" value="Clear Filter" /></a>
            </div>
        </div>
	
	</div>
		<c:set value="${OTH_PAGE_LIST}" var="fltPageList" />
	<table class="view_task_table" style="width:80%; margin-left: auto;margin-right: auto;">
        <thead style="background:#6082B6;height:50px;">
            <tr>
                ...
                <th style="width:10%;"><a style="color:black;" href="#">Service Name</a></th>
                <th style="width:25%;"><a style="color:black;" href="#">Service Details</a></th>
                <th style="width:10%;"><a style="color:black;" href="#">Service Date</a></th>
		...
		<c:forEach items="${fltPageList}" var="flt">
				<tr>
					...
					<td style="width:10%;">${flt.serviceName}</td>
					<td style="width:25%;">${flt.serviceDetails}</td>
					<td style="width:10%;"><fmt:formatDate value="${flt.serviceDate}" pattern="dd-MM-yyyy" /></td>
