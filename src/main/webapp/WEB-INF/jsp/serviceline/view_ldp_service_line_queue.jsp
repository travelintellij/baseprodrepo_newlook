...
<body>
 ...
 <div class="cnt_options ">
            ...
            <a href="get_landpackage_service_line_queue_user" style="color:white;background:black" >Land Package</a>
...
<br>	
<h3 align="center"><b>Land Package Service Line</b></h3>
...
<form:form action="get_landpackage_service_line_queue_user" modelAttribute="FILTER_SL">
        <div class="view_task_wrapper bs">
            ...
            <div class="due_today_task_data_btnss" style="display:flex;justify-content:center;margin-top:10px">
              ...
              <a href="get_landpackage_service_line_queue_user"><input type="button" value="Clear Filter" /></a>
            </div>
        </div>
	
	</div>
		<c:set value="${LDP_PAGE_LIST}" var="fltPageList" />
	<table class="view_task_table" style="width:80%; margin-left: auto;margin-right: auto;">
        <thead style="background:#6082B6;height:50px;">
            <tr>
                ...
                <th style="width:10%;"><a style="color:black;" href="#">Destination</a></th>
                <th style="width:10%;"><a style="color:black;" href="#">Package Name</a></th>
		...
		<c:forEach items="${fltPageList}" var="flt">
				<tr>
					...
					<td style="width:10%;">${flt.destinationName}</td>
					<td style="width:10%;">${flt.packageName}</td>
					<td style="width:10%;"><fmt:formatDate value="${flt.startDate}" pattern="dd-MM-yyyy" /></td>
					<td style="width:10%;"><fmt:formatDate value="${flt.endDate}" pattern="dd-MM-yyyy" /></td>
