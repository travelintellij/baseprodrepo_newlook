...
<form:form action="get_insurance_service_line_queue_user" modelAttribute="FILTER_SL">
		...
		<c:set value="${INS_PAGE_LIST}" var="fltPageList" />
	<table class="view_task_table" style="width:80%; margin-left: auto;margin-right: auto;">
        <thead style="background:#6082B6;height:50px;">
            <tr>
                ...
                <th style="width:10%;"><a style="color:black;" href="#">Coverage Amount</a></th>
                <th style="width:10%;"><a style="color:black;" href="#">Coverage Start Date</a></th>
                <th style="width:10%;"><a style="color:black" href="#">Coverage End Date</a></th>
		...
		<c:forEach items="${fltPageList}" var="flt">
				<tr>
					...
					<td style="width:10%;">${flt.coverageCurrency} ${flt.coverageAmount}</td>
					<td style="width:10%;">${flt.coverageStartDate}</td>
					<td style="width:10%;">${flt.coverageEndDate}</td>
