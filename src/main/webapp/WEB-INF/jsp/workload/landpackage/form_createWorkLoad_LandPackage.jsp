...
<body style="background-color: white;">
	<br>
	<h2 align="center">
		Add LandPackage Details
	</h2>
	<hr>
		<form:form modelAttribute="LDP_SL_OBJ" action="create_create_workload_LDP">
		...
		<table id="flight-sl" style="border: 3px solid black;width:85%;">
			<tr>
				...
				<th style="width: 13%;" align="center">Package Name</th>
				<td style="width: 20%;" align="center">
				...
				<td style="width: 20%;" align="center">
					<div class="select">
						<select id="supplierId" name="supplierId" style="width: 200px;height:40px;" required>
							<c:if test="${not empty LDP_SUPPLIER_LIST}">
								<c:forEach items="${LDP_SUPPLIER_LIST}" var="supplierObj">
									<option class="service-small" value="${supplierObj.supplierId}">${supplierObj.supplierName}</option>
								</c:forEach>
							</c:if>
						</select>
					</div>
				...
				<tr>		
				<th colspan="6" align="center"><b>Package Details (Inclusions)</b></th>
				</tr>
				<tr>		
