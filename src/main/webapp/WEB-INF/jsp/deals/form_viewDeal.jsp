...
body::before {
	content: "";
	background-image:
		url(${pageContext.request.contextPath}/resources/images/revamped/lens.jpg);
...
<body>
	<div class="form_viewDeal container">
		<div class="form_viewDeal_wrapper">
			...
			<form:form modelAttribute="dealRecorder"
				action="edit_workload_MainDealRecord">
				...
				<div class="form_viewDeal_wrapper_data">
					...
					<div class="form_viewDeal_wrapper_data_line_des a"
