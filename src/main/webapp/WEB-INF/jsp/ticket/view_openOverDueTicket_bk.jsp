...
<div class="sidenav">
  ...
  <a href="view_open_over_due_ticket_form_user" style="background-color: red;color:white;">Over Due</a>
  	...
  	<input type="hidden" name="dateTo" value="${dateTo}" />
		<table style="width: 100%;">
			<tr >
	        	...
	        	<td>
	        		<div class="select">
						<select id = "ticketPriority" name="ticketPriority" style="width: 160px;">
				...
				<td style="width:27%;height:30px"><a href="view_open_over_due_ticket_form_user"><input type="button" value="Clear Filter" /></a></td>
		...
		<hr>
			...
			<table>
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_over_due_ticket_form_user?sortBy=ticketId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Ticket Id</a></th>
				<th style="width:20%;">Ticket Title</th>
				<th style="width:10%;">Client Associated</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_over_due_ticket_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_over_due_ticket_form_user?sortBy=ticketOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_over_due_ticket_form_user?sortBy=ticketPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_over_due_ticket_form_user?sortBy=ticketDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Due Date</a></th>
				<th style="width:10%;">Action</tr>
			...
			<tr>
				...
				<td style="width:15%;"><font color="red">${localDateTimeFormat.format(openTicketList.ticketDueDate)}</font></td>
				<td style="width:10%;">
					<a href="view_view_over_due_ticket?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_over_due_ticket?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="Edit" /></a> 
				</td>
				...
				Page: 
			    <c:url value="view_open_over_due_ticket_form_user" var="prev">
			    ...
			    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
			        <c:choose>
			            ...
			            <c:otherwise>
			                <c:url value="view_open_over_due_ticket_form_user" var="url">
			    ...
			    <c:url value="view_open_over_due_ticket_form_user" var="next">
			        <c:param name="page" value="${page + 1}"/>
			    </c:url>
