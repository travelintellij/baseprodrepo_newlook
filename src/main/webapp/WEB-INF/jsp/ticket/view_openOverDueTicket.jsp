...
<head>
    ...
    <title>over due ticket</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/revamped/style.css">
</head>

<body
    style="background: url(${pageContext.request.contextPath}/resources/images/revamped/over_due_ticket_bg.jpg);background-size: cover; background-repeat: no-repeat; background-position: center center;background-attachment: fixed;">
    ...
    <div class="over_due_ticket container">
        <div class="over_due_ticket_wrapper">
            <div align="center"><b>
            ...
            <form:form action="view_open_over_due_ticket_form_user" modelAttribute="TICKET_FILTER_OBJ">
                <div class="over_due_ticket_wrapper_data">
                    ...
                    <div class="over_due_ticket_wrapper_data_li">
                        <label for="">Ticket Confirmation Id</label>
                ...
                <div class="due_today_task_data_btns">
                    ...
                    <a href="view_open_over_due_ticket_form_user">Clear Filter</a>
                </div>
            </form:form>
        </div>
