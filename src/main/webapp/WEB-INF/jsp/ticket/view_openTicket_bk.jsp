...
<div class="sidenav">
  ...
  <a href="view_open_ticket_form_user" style="background-color: red;color:white;">Open Tickets</a>
...
<br><br>
  ...
  <form:form action="view_open_ticket_form_user" modelAttribute="TICKET_FILTER_OBJ">
		...
		<tr>
			...
			<td><input style="width:150px;" class="form-control search-slt" type="number" name="ticketId" id="ticketId" step="0.0" placeholder="Ticket Id " /></td><td colspan="7">&nbsp;</td>
		</tr>
			<tr >
				...
				<td style="height:30px"><a href="view_open_ticket_form_user"><input type="button" value="Clear Filter" /></a></td>
			</tr>
		</table>
		<hr>
			...
			<table>
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_ticket_form_user?sortBy=ticketId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Ticket Id</a></th>
				<th style="width:20%;">Ticket Title</th>
				<th style="width:10%;">Client Associated</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_ticket_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_ticket_form_user?sortBy=ticketOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_ticket_form_user?sortBy=ticketPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_ticket_form_user?sortBy=ticketDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Due Date</a></th>
			...
			<tr>
				...
				<td style="width:10%;">
					<a href="view_view_ticket?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_ticket_req?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="Edit" /></a> 
				</td>
			</tr>
