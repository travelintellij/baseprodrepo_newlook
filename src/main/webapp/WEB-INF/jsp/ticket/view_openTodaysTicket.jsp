...
<div class="sidenav">
  ...
  <a href="view_open_ticket_form_user_filter_due_today"  style="background-color: red;color:white;">Due Today</a>
  	...
  	<input type="hidden" name="dateTo" value="${dateTo}" />
		<table>
			<tr >
				...
				<td style="width:27%;height:30px"><a href="view_open_ticket_form_user_filter_due_today"><input type="button" value="Clear Filter" /></a></td>
		...
		<hr>
			...
			<tr>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_due_today_ticket_form_user?sortBy=ticketId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Ticket Id</a></th>
				<th style="width:20%;">Ticket Title</th>
				<th style="width:10%;">Client Associated</th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_due_today_ticket_form_user?sortBy=dealConfirmationId&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Deal Associated</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_due_today_ticket_form_user?sortBy=ticketOwner&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Assigned To</a></th>
				<th style="width:10%;"><a style="color:#ffffa0;" href="view_open_due_today_ticket_form_user?sortBy=ticketPriority&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Priority</a></th>
				<th style="width:15%;"><a style="color:#ffffa0;" href="view_open_due_today_ticket_form_user?sortBy=ticketDueDate&dateFrom=${dateFrom}&dateTo=${dateTo}&ticketOwner=${ticketOwner}&dealConfirmationId=${dealConfirmationId}&ticketPriority=${ticketPriority}">Due Date</a></th>
			...
			<tr>
				...
				<td style="width:10%;">
					<a href="view_view_due_today_ticket?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="View" /></a> | 
					<a href="view_form_edit_due_today_ticket?ticketId=${openTicketList.ticketId }"><input type="button" style="background-color: #786AAF;" value="Edit" /></a> 
				</td>
