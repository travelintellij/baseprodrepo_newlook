    ...
    font-weight: 800;">Select Services</label></div>
                        ...
                        <div class="edit_lead_wrapper_data_l1_rem" style="margin-top: 10px; display: flex;">
                            <div class="edit_lead_wrapper_data_l1_rem1" style="flex: 1;">
                                ...
                                <form:textarea path="clientRemarks" maxlength="1450" style="width: 100%; box-sizing: border-box;" rows="5" />
                            </div>
                            <div class="edit_lead_wrapper_data_l1_rem2" style="flex: 1; margin-left: 17px;">
                                ...
                                <form:textarea path="internalRemarks" maxlength="1450" style="width: 100%; box-sizing: border-box;" rows="5" />
                            </div>
                        </div>
