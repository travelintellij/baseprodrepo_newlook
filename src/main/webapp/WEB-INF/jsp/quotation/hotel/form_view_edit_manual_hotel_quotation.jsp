                        ...
                        <h1 class="hd">Edit Hotel Stay</h1>
                            <div class="form_view_add_manual_hotel_quotation_wrapper">
                                ...
                                <div class="form_view_add_manual_hotel_quo_box">
                                    ...
                                    <select id="roomCategoryId" name="roomCategoryId" id="roomCategoryId"
                                        style="width:90%" required>
                                        <option class="service-small" value="" selected>Select Category</option>
                                        <c:if test="${not empty SELECTED_HOTEL_ALL_ROOM_CATEGORY}">
                                            <c:forEach items="${SELECTED_HOTEL_ALL_ROOM_CATEGORY}"
                                                var="htl_sl_htl_room_cat">
                                                <c:if
                                                    test="${MANUAL_HTL.roomCategoryId eq htl_sl_htl_room_cat.roomCategoryId }">
                                                    <option class="service-small"
                                                        value="${htl_sl_htl_room_cat.roomCategoryId}" selected>
                                                        ${htl_sl_htl_room_cat.roomCategoryName}</option>
                                                </c:if>
                                                <c:if
                                                    test="${MANUAL_HTL.roomCategoryId ne htl_sl_htl_room_cat.roomCategoryId }">
                                                    <option class="service-small"
                                                        value="${htl_sl_htl_room_cat.roomCategoryId}">
                                                        ${htl_sl_htl_room_cat.roomCategoryName}</option>
                                                </c:if>
                                            </c:forEach>
                                        </c:if>
                            ...
                            <div class="due_today_task_data_btnss">
                                <input type="submit" name="editHotel" id="editHotel" Value="Update Hotel Stay" />
                                <a
