...
<form:form modelAttribute="MANUAL_INS" action="edit_edit_insurance_manual_quotation">
	...
	<form:hidden path = "manualInsuranceQuotationId" />
		<table style="width:100%;  table-layout:fixed;background-color: #DFE0DC; border: 3px solid #000000; border-collapse: collapse" id="editInsuranceTable">
					...
					<tr>
						<th style="background-color:#DAF7A6;" colspan="5">
							<input type="submit" style="background-color:blue;" value="Update Insurance" />
