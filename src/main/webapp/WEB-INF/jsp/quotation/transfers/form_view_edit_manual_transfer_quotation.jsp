...
<form:form modelAttribute="MANUAL_TRN" action="edit_edit_transfer_manual_quotation">
	...
	<table style="width:100%;  table-layout:fixed;background-color: #DFE0DC; border: 3px solid #000000; border-collapse: collapse" id="newflightStop">
		<tr><th style="background-color:#800000" colspan="5"><font size="4"><b>Transfer Id-  ${MANUAL_TRN.manualTransferQuotationId}</b></font></th></tr>
		<tr>
		...
		<tr>
			<th colspan="5"><input type="submit" name="editTransfer" id="editTransfer" Value="Update Transfer" />
