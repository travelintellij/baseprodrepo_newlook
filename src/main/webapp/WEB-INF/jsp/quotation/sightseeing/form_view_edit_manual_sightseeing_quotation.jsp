...
<form:form modelAttribute="MANUAL_STS" action="edit_edit_sightseeing_manual_quotation">
	...
	<h1><b>Id-  ${MANUAL_STS.manualSightSeeingQuotationId}</b></h1>
            <div class="sssec_wrapper_data_try" style="border:2px solid red">
            ...
            <div class="sssec_wrapper_data">
                ...
                <div class="sssec_wrapper_data_line">
                  ...
                  <form:input path="sightSeeingCost" type="number" min="0" style="height:30px;width:120px;margin: auto;"/>
                </div>
                <div class="sssec_wrapper_data_line">
                    <label for="" class="lb">Sight Seeing Markup</label>
                 <form:input path="sightSeeingMarkup" type="number" min="0" style="height:30px;width:80px;margin: auto;"/>
                </div>
                <div class="sssec_wrapper_data_line">
                    <label for="" class="lb">Display Order</label>
                  <form:input path="displayOrder" type="number" min="0" style="height:30px;width:50px;margin: auto;"/>
                </div>
            </div>
            <div class="sssec_wrapper_data">
