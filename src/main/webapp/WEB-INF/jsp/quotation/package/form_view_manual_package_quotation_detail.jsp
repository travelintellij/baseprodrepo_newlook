            ...
            <div class="com_page_wrapper_data">
                ...
                <div class="due_today_task_data_btnss" style="margin-top:20px">
                    <c:if test="${QTN_OBJ.converted ne true }">
                        ...
                        <a
                            href="form_view_delete_manual_package_quotation?manualPkgQuotationId=${MANUAL_PKG.manualPkgQuotationId}&quotationId=${QTN_OBJ.quotationId}&leadId=${QTN_OBJ.leadEntity.leadId}"><input
                                type="button" style="background-color:red;" value="Delete Package" /></a>
                    </c:if>
                    <c:if test="${QTN_OBJ.converted eq true }">
                        <a><input type="button" style="background-color:lightgray;" name="editPackage" id="editPackage"
