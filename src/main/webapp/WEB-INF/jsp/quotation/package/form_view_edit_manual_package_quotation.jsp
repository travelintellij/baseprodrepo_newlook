...
<form:form modelAttribute="LEAD_OBJ" action="create_create_lead_quotation">
	...
	<h3 align="center"><font color="blue"><b>Edit Package</b></font></h3>
...
<div class="float-container">
	...
	<tr><td>
<form:form modelAttribute="MANUAL_PKG" action="edit_edit_package_manual_quotation">
	...
	<table style="width:100%;  table-layout:fixed;" >
		...
		<tr>
			<th colspan="5" style="background-color:#CD5C5C;"> Exclusions</th>
		</tr>
		<tr>
		...
		<tr>	
			<th colspan="5" style="background-color:#CD5C5C;"><font size="4"><b>Cancellation Policy</b></font> (If left empty, it won't be printed)</th>
		</tr>
		<tr>
		...
		<tr>	
			...
			<td>
				<div class="gender" align="center">
					<c:if test="${MANUAL_PKG.flightIncluded eq true}">
						<input type="radio" value="true" id="yes" name="flightIncluded"  checked /> <label for="yes" class="radio">Yes</label>
	       				<input type="radio" value="false" id="no" name="flightIncluded"   /> <label for="no" class="radio">No</label>
	       			</c:if>
	       			<c:if test="${MANUAL_PKG.flightIncluded eq false}">
		...
		<tr>
			<th colspan="5"><input type="submit" name="UpdatePackage" id="updatePackage" Value="Update Package" />
