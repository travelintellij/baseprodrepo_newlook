...
<div class="float-container">
	...
	<tr><td>
<form:form modelAttribute="MANUAL_PKG" action="form_view_edit_manual_package_quotation">
	...
	<table style="width:100%;  table-layout:fixed;" >
		...
		<tr>
			<th colspan="5" style="background-color:green;">Inclusions hello </th>
		...
		<tr>
			<th colspan="5">
				<c:if test="${QTN_OBJ.converted ne true }">
					...
					<a href="form_view_delete_manual_package_quotation?manualPkgQuotationId=${MANUAL_PKG.manualPkgQuotationId}&quotationId=${QTN_OBJ.quotationId}&leadId=${QTN_OBJ.leadEntity.leadId}"><input type="button" style="background-color:red;" value="Delete Package" /></a>
				</c:if>
				<c:if test="${QTN_OBJ.converted eq true }">
					<a><input type="button"  style="background-color:lightgray;" name="editPackage" id="editPackage" Value="Edit Package" /></a>
