...
<jsp:include page="../_quotationServicesMenu.jsp" />
                    ...
                    <div class="form_vaccmquotation container">
                        ...
                        <form:form modelAttribute="MANUAL_CNF"
                            action="create_update_costing_remarks_manual_configuration_quotation">
                            ...
                            <div class="form_vaccmquotation_btns due_today_task_data_btnss">
                                ...
                                <c:if test="${QUOTATION_EXISTS eq false}">
                                    ...
                                    <td colspan="2"><input type="submit" name="Generate Quotation"
                                            id="Generate Quotation" Value="Generate Quotation" /></td>
                                    <td colspan="2"><a
                                            href="view_lead_quotations_list?leadId=${QTN_OBJ.leadEntity.leadId}"><input
                                                type="button" value="List Versions" /></a>
                                </c:if>
                            </div>
                            <!-- ########### second box  ends #########  -->
