...
<div class="float-container">
    ...
    <div class="blue">
		...
		<caption><font size="4"> <b>Configure Quotation</b></font></caption>
			<tr>
				<td style="text-align:center;">
				<ul>
		  			<li><a href="#"> <input type="button" style="background-color:blue;" value="Search Hotel" /></a></li>
		  			<li><a href="form_view_add_hotel_quotation?leadId=${LEAD_OBJ.leadId }&quotationId=${QTN_OBJ.quotationId}"><input type="button" style="background-color:green;" value="Add Manually" /></a></li>
				</ul>
				</td>
			</tr>
		</table>
