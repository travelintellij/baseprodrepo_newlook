...
<div class="float-container">
	...
	<td style="background-color:green;" colspan="3">
      ...
      <table  id="files-sl" style="width:70%;height: 10px;">
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #FF5733;color:black;font-size:18px;" >To: </th>
	          <td style="text-align: left;">
	          	<form:input type="text" id="emailMessageVo.emailToList" path="emailMessageVo.emailToList" style="width: 400px;height: 30px; border-color: lightblue !important;" />
	          	<font color="red"><form:errors path="emailMessageVo.emailToList" cssClass="error" /></font>
	          </td>
	    </tr>
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #FF5733;color:black;font-size:18px;" >Cc: </th>
	          <td style="text-align: left;">
	          	<form:input type="text" path="emailMessageVo.emailCcList" style="width: 400px;height: 30px; border-color: lightblue !important;" />
	          	<font color="red"><form:errors path="emailMessageVo.emailCcList" cssClass="error" /> </font>
	          </td>
	    </tr>
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #FF5733;color:black;font-size:18px;" >Subject: </th>
	          <td style="text-align: left;"><form:input type="text" path="emailMessageVo.emailSubject" style="width: 500px;height: 30px; border-color: lightblue !important;"  /></td>
	    </tr>
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #FF5733;color:black;font-size:18px;" >Message: </th>
	          <td style="text-align: left;">	<form:textarea style="width: 1000px; height: 300px;border: 2px solid green; border-radius: 4px;" rows="3" cols="1500" path="emailMessageVo.emailMessage" htmlEscape="false" /></td>
	    </tr>
	
		<tr><th colspan="2"> Quotation Attached</th></tr>
