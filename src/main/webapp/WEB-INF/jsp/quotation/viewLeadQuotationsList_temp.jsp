                ...
                <c:forEach items="${LEAD_OBJ.leadQuotationsList}" var="leadquotations">
                    <tr>
                        ...
                        <c:if test="${ (leadquotations.converted ne true)  }">
                            <c:choose>
                                <c:when
                                    test="${ (leadquotations.version gt CONVERTED_QTN.version) && (CONVERTED_QTN.version gt 0) }">
                                    <td style="border-width:5px;;">
                                        <a
                              ...
                              <!-- these btns are shown as of now ,starts here -->
                                ...
                                <c:otherwise>
                                    <td style="border-width:5px;;">
                                        ...
                                        <a href="form_convert_new_deal?leadId=${LEAD_OBJ.leadId }&quotationId=${leadquotations.quotationId }"
                                            aria-disabled="true"><input type="button"
                                    ...
                                    <!-- these btns are shown as of now ,ends here -->
