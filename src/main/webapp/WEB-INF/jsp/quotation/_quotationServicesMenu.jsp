...
<%@ taglib prefix = "fmt" uri = "http://java.sun.com/jsp/jstl/fmt" %>
 <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/revamped/style.css">
	...
	<a href="checkItineraryExists?quotationId=${QTN_OBJ.quotationId }"><input type="button" style="background:transparent;outline:none;border:none;width:100%;cursor:pointer;color:black;font-weight:Bold;margin:0 10px"  value="Itinerary" /></a>
