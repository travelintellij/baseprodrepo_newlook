                                ...
                                <h1 class="hd">Reminder</h1>
                                    <div class="rso_wrapper_data_line a">
                                        ...
                                        <div class="rso_wrapper_data_l1">
                                            ...
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.contactName}</p>
                                        </div>
                                    </div>
                                    <div class="rso_wrapper_data_line a">
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Lead Owner</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.leadOwnerName}2</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Source</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.sourceName}</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Destination</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.destinationName}</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Adults</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.adults}</p>
                                        </div>
                                    </div>
                                    <div class="rso_wrapper_data_line a">
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Chlidren</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.children}2</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Age</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.childrenAgeInfo}</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                            <label for="" class="">Lead Source</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.leadSourceName}</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1">
                                    ...
                                    <div class="rso_wrapper_data_line a">
                                        ...
                                        <div class="rso_wrapper_data_l1p">
                                            ...
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.tentativeCost}</p>
                                        </div>
                                        <div class="rso_wrapper_data_l1p">
                                            <label for="" class="">Status</label>
                                            <p style="color:#023e8a;font-weight:800">${REMINDER_SERVICE.leadsRecorderObj.statusName}</p>
                                        </div>
                                    </div>
                                    <p style="text-align: start;" class="">Services requested</p>
