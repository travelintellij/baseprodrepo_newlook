...
<div class="main-block">
	<form:form method="post" action="adminViewDeleteClient"		modelAttribute="tag">
		<div id="table">
			<table align="center">
				<tr>
					<td>Please type to search and delete client.</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<center>
							<button id="w-button-search" type="Submit">Fetch client	to delete</button>
						</center>
					</td>
				</tr>
			</table>
