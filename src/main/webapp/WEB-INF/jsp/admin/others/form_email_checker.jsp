...
<h2 align="center"> Check Email Working</h2>
	<div align="center"><b><font color="green" > ${Success} </font><font color="red"> ${Error}</font> </b></div>
	 
      <form:form name="reqQuotationEmailForm" id="reqQuotationEmailForm" action="send_send_email_check" style="display:inline;" modelAttribute="EMAIL_MSG_VO" >

      <table  style="width:70%;">
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #darkblue;" >From: </th>
	          <td style="text-align: left;">
	          	<input type="text" name="emailMessageFrom" style="width: 500px;height: 40px; border-color: lightblue !important;" value="${EMAIL_MSG_VO.emailMessageFrom}"/>
	    ...
	    <tr>
	          ...
	          <td style="text-align: left;">
	          	<input type="text" name="emailToList" style="width: 500px;height: 40px; border-color: lightblue !important;" value="${EMAIL_MSG_VO.emailToList}"/>
	          	<font color="red"><form:errors path="emailToList" cssClass="error" /></font>
	          </td>
	    </tr>
	    ...
	    <tr>
	          ...
	          <td style="text-align: left;">
	          	<input type="text" name="emailCcList" style="width: 500px;height: 40px; border-color: lightblue !important;" value="${EMAIL_MSG_VO.emailCcList}" />
	    ...
	    <tr>
	          ...
	          <td style="text-align: left;">
	          		<input type="text" name="emailSubject" style="width: 500px;height: 40px; border-color: lightblue !important;" value="${EMAIL_MSG_VO.emailSubject}" />
	          </td>
	    </tr>
	    <tr>
	          <th style="width:20%;text-align: center;vertical-align: middle;background: #FF5733;" >Message: </th>
	          <td style="color:black;text-align: left;">	<form:textarea path = "emailMessage" rows="10" cols="100"  maxlength="1450" /></td>
	    </tr>
