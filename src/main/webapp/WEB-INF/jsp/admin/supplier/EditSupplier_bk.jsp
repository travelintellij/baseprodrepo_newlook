...
<br>
<br>
<h2 align="center">Edit Supplier <font color="#D33F14">(Supplier Id : ${SUPPLIER_OBJ.supplierId})</font></h2>
		...
		<tr>
			...
			<td  style="width:40%;">
				...
				<tr><td colspan="2">
					...
					<tr>
						<th style="width:20%;">Package </th><td style="width:13%;"><label class="container" style="display: inline;margin: 0 auto;margin-bottom: 20px;"><form:checkbox path="landPackage" /><span class="checkmark"></span></label></td>
						<th style="width:20%;">Cruise </th><td style="width:13%;"><label class="container" style="display: inline;margin: 0 auto;margin-bottom: 20px;"><form:checkbox path="cruise" /><span class="checkmark"></span></label></td>
			...
			<tr>
				<td colspan="3" style="text-align: center;"><input type="submit" value="Update Supplier" style="background-color: green;">
						<a href="view_form_admin_search_supplier"><input type="button" style="width: 160px;background-color: blue;" value="Search Supplier"></a>
						<a href="view_supplier_contacts_listing?supplierId=${SUPPLIER_OBJ.supplierId }"><input type="button" style="width: 160px;background-color: blue;" value="Contact Listing"></a> 
				</td>
			</tr>
		</table>
</form:form>
