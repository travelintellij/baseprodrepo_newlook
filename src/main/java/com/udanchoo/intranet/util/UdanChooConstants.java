...
public interface UdanChooConstants {
	...
	////////////// Following block of constants are related to Flight Service line
	////////////// object only //////////////////
	 ...
	 * public static Map<Object, Object> FLT_TICKET_TYPE_LIST = new HashMap<Object,
	 * Object>() {{
	 * put(1,"Economy");
	...
	static final Map<Integer, String> FLT_TICKET_TYPE_LIST = new HashMap<Integer, String>() {
		{
			...
			put(6, "First");
			// Cabin class (1 for All, 2 for Economy, 3 for PremiumEconomy, 4 for Business,
			// 5 for PremiumBusiness, 6 for First)
		}
	};
	 ...
	 * put(3,"First");
	 * put(4,"Other");
	 * //Cabin class (1 for All, 2 for Economy, 3 for PremiumEconomy, 4 for
	 * Business, 5 for PremiumBusiness, 6 for First)
	 * }
	 * };
	 */
	static final Map<Integer, String> CABIN_CLASS = new HashMap<Integer, String>() {
	...
	/*
	 * static final Map<Integer, String> TARGET_STATUS = new HashMap<Integer,
	 * String>(){
	 * {
	 * put(0,"All");
	 * put(1,"Pending");
