...
@Component
public class HotelQuotationValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		ManualHotelQuotationVO manualHotelQuotationVO = (ManualHotelQuotationVO)target;
		if(!commonService.existsByDestinationIdAndCityName(manualHotelQuotationVO.getCityId(),manualHotelQuotationVO.getCityName())) {
