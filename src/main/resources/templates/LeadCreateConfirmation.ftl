        ...
        <tr>
            ...
            <tr>
                <td style="background-color: #f8fafc; padding: 30px; text-align: center;">
                    ...
                    <br/>
                    <h1 style="display: inline-block; background-color: #e0f2fe; color: #0369a1; margin: 15px 0 0 0; padding: 8px 20px; border-radius: 6px; font-size: 22px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px;">Query Confirmation</h1>
                </td>
            </tr>
            <!-- Content -->
            <tr>
                <td style="padding: 40px 30px; color: #1e293b; font-size: 15px; line-height: 1.6; text-align: left;">
                    ...
                    <p style="margin: 0 0 16px 0;">Thank you for choosing <strong>UdanChoo</strong>! We have registered a new query in our system based on your travel request.</p>
                    ...
                    <p style="margin: 0 0 16px 0;">We are working on creating a customized quotation to offer you the best options and pricing. You will receive the proposal from us shortly.</p>
