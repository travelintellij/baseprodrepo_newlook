                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/b524536bce55ad238411aa638/images/3152a14c-0d30-48b5-95ed-3dbae2d40bf6.png" width="235" style="max-width:500px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                    	...
                                                    	<td align="center" colspan="3" valign="top">
                                                        	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="headerFrontBackground">
                                                                <tr>
                                                                    <td align="center" valign="top">
                                                                        <!-- BEGIN HEADER // -->
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="" bgcolor="red">
                                                                            <tr>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                           ...
                           There is an update on your task done by ${taskCreator} as mentioned below.
<br><br>

<span> <mark style="background-color: yellow;">BELOW MENTIONED TASK IS DELETED AND NO LONGER EXISTS.  </mark></span>
.&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br>
<br>
<strong>Task Id </strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${taskId}<br>
<strong>Task Title</strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ${taskTitle}<br>
<br>
<strong>Description</strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${taskDesciption}<br>
<br>
<br>
<strong>Priority </strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${taskPriority}<br>
<strong>Due Date</strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${taskDueDate}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br><br>
<strong>Status</strong>:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${taskStatus}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
